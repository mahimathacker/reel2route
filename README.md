...
7. **Real place validation, mocked tours.** Google Places verifies geography. The tour catalogue is deliberately marked `mock`; it provides dependable recommendation behavior without claiming access to bookable inventory.
